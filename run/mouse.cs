...
public class MouseSimulator {
    public static void Main (params string[] args) {
        ...
        if (method == "click" || method == "leftDown") { mouse_event(0x2, posX, posY, 0, 0); }
        if (method == "click") { mouse_event(0x4, 0, 0, 0, 0); }
        if (method == "leftUp") { mouse_event(0x4, posX, posY, 0, 0); }

        if (method == "rightClick" || method == "rightDown") { mouse_event(0x8, posX, posY, 0, 0); }
